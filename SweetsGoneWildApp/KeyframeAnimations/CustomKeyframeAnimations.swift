//
//  CustomKeyframeAnimations.swift
//
    ...
    for idx in copy.keyframes.indices {
      ...
      if k.startVelocity == nil && idx > 0 {
        ...
        if previous is MyLinearKeyframe<Value> {
          ...
          //  k.startVelocity = p.endVelocity initial smooth implementation (smoother curve connection then apple keyframe API)
      ...
      if k.endVelocity == nil && idx + 1 < keyframes.count {
...
//
//extension CGFloat:  @retroactive Animatable {
